...
window.CITY = {
  practice: {
    ...
    hero: {
      ...
      sub: "Every building is a solution we shipped on the Microsoft cloud — Power Platform, Dynamics 365, Copilot and Azure AI. Explore the landscape and click any building to see its story.",
      stats: [
      ...
      note: "Each island is one client’s separate Microsoft tenant — drag to move, orbit with the compass, and click any building to see what we run and what it’s worth.",
    },
