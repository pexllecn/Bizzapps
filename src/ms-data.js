...
window.CITY = {
  practice: {
    ...
    hero: {
      ...
      headline: "Solutions,",
      headlineAccent: "built as a city.",
      sub: "Every building is a real client engagement EY has delivered on the Microsoft cloud — Power Platform, Dynamics 365, Copilot and Azure AI. Explore the landscape and click any building to see its story.",
      stats: [
      ...
      note: "Each island is one client’s separate Microsoft tenant. Drag to orbit, scroll to zoom, and click a building — the camera stays where you left it while you read.",
    },
